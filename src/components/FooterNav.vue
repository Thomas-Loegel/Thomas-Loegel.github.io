<template>
  <footer class="footer">
    ...
    <div class="social">
      ...
      <a class="social-link" href="https://www.linkedin.com/in/thomas-loegel-095b61194/" target="_blank" rel="noopener noreferrer">
        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin" class="linkedin-svg" role="img" width="22px" height="22px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
